...
cp -pr conf/* %{buildroot}/usr/share/%{username}/default.conf
...
cp redhat/snappy-java-*.jar.zip -d %{buildroot}/usr/share/%{username}/lib
cp -p ../../../../switch_snappy %{buildroot}/usr/share/%{username}
